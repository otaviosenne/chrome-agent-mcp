...
export const snapshotToolDefinition = {
    ...
    description: "Capture accessibility snapshot of a page. Returns the page structure with element refs for interaction. " +
...
export function wrapForEvaluation(expression) {
    const trimmed = expression.trim();
    if (trimmed.startsWith("("))
        return expression;
    if (!NEEDS_IIFE_RE.test(trimmed))
        return expression;
    return `(async () => {\n${trimmed}\n})()`;
}
