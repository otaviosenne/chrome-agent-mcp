...
import { GroupStateStore, STATE_DIR } from "./state.js";
...
export class TabGroupManager {
    ...
    async tryAddToVisualGroup(cdpTabId) {
        ...
        if (!this.extensionClient)
            return;
        const newGroupId = await this.api.tryAddToVisualGroup(cdpTabId, this.ownedTabIds, this.chromeGroupId, this.groupName, this.groupColor, this.extensionClient);
        if (newGroupId !== null) {
